...
export const OPENAPI_CATALOG: CatalogOp[] = [
  ...
  { method: 'get', path: '/absences/upcoming-calls', tag: 'Présence', summary: 'Rappels d’appel (enseignant, créneaux dans N minutes)', auth: 'bearer', roles: ['teacher', 'head_teacher'] },
  ...
  { method: 'post', path: '/finance/fee-items', tag: 'Finance', summary: 'Créer un frais', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'patch', path: '/finance/fee-items/:id', tag: 'Finance', summary: 'Modifier un frais', auth: 'bearer', roles: [...finance] },
  { method: 'delete', path: '/finance/fee-items/:id', tag: 'Finance', summary: 'Supprimer un frais', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/fee-types', tag: 'Finance', summary: 'Catalogue types de frais (plateforme + custom)', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-types', tag: 'Finance', summary: 'Créer un type de frais établissement', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'patch', path: '/finance/fee-types/:id', tag: 'Finance', summary: 'Modifier un type custom (pas le catalogue plateforme)', auth: 'bearer', roles: [...finance] },
  { method: 'delete', path: '/finance/fee-types/:id', tag: 'Finance', summary: 'Désactiver un type custom', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/national-fees', tag: 'Finance', summary: 'Lire le référentiel national publié (État)', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/fee-schedules', tag: 'Finance', summary: 'Lister les grilles tarifaires', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/fee-schedules/:id', tag: 'Finance', summary: 'Lire une grille tarifaire', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-schedules', tag: 'Finance', summary: 'Créer une grille brouillon', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'put', path: '/finance/fee-schedules/:id/items', tag: 'Finance', summary: 'Remplacer les items d’un brouillon', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-schedules/:id/validate', tag: 'Finance', summary: 'Valider une grille (comptable)', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-schedules/:id/publish', tag: 'Finance', summary: 'Publier une grille (direction ; Idempotency-Key)', auth: 'bearer', roles: [...direction] },
  { method: 'post', path: '/finance/fee-schedules/:id/archive', tag: 'Finance', summary: 'Archiver une grille', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-schedules/:id/revise', tag: 'Finance', summary: 'Créer une nouvelle version brouillon', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'post', path: '/finance/fee-schedules/:id/generate-invoice', tag: 'Finance', summary: 'Émettre une facture depuis une grille publiée', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'get', path: '/finance/fee-plan-templates', tag: 'Finance', summary: 'Lister les templates d’échéancier', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-plan-templates', tag: 'Finance', summary: 'Créer un template d’échéancier', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'delete', path: '/finance/fee-plan-templates/:id', tag: 'Finance', summary: 'Désactiver un template', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/fee-plan-templates/:id/apply', tag: 'Finance', summary: 'Appliquer un template → plan + factures', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'get', path: '/finance/student-fee-assignments', tag: 'Finance', summary: 'Lister les affectations élève → grille', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/student-fee-assignments', tag: 'Finance', summary: 'Créer / mettre à jour une affectation élève → grille', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'patch', path: '/finance/student-fee-assignments/:id', tag: 'Finance', summary: 'Modifier options / clôturer une affectation', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/student-fee-assignments/:id/generate-invoice', tag: 'Finance', summary: 'Émettre une facture depuis une affectation', auth: 'bearer', roles: [...finance], statuses: [201] },
  ...
  { method: 'post', path: '/finance/invoices', tag: 'Finance', summary: 'Émettre une facture', auth: 'bearer', roles: [...finance], statuses: [201] },
  { method: 'patch', path: '/finance/invoices/:id/cancel', tag: 'Finance', summary: 'Annuler une facture', auth: 'bearer', roles: [...finance] },
  ...
  { method: 'post', path: '/finance/bank-statement/lines/:id/auto-match', tag: 'Finance', summary: 'Rapprochement auto (candidat unique)', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/bank-statement/lines/:id/match', tag: 'Finance', summary: 'Rapprochement manuel', auth: 'bearer', roles: [...finance] },
  { method: 'delete', path: '/finance/bank-statement/lines/:id/match', tag: 'Finance', summary: 'Annuler un rapprochement', auth: 'bearer', roles: [...finance] },
  { method: 'post', path: '/finance/bank-statement/lines/:id/ignore', tag: 'Finance', summary: 'Ignorer une ligne', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/bank-statement/summary', tag: 'Finance', summary: 'Bilan de rapprochement', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/verify/:token', tag: 'Finance', summary: 'Vérification publique d’un reçu (QR)', auth: 'public' },
  { method: 'get', path: '/finance/balances', tag: 'Finance', summary: 'Soldes élèves à une date', auth: 'bearer', roles: [...finance] },
  { method: 'get', path: '/finance/balances/export', tag: 'Finance', summary: 'Export CSV/XLSX des soldes (journalisé)', auth: 'bearer', roles: [...finance] },
  ...
  { method: 'get', path: '/admin/platform-ops-acl', tag: 'Ops admin', summary: 'ACL scopes ops plateforme (déprécié)', auth: 'bearer', roles: ['admin'] },
  { method: 'put', path: '/admin/platform-ops-acl', tag: 'Ops admin', summary: 'Mettre à jour l’ACL ops (déprécié)', auth: 'bearer', roles: ['admin'] },
  { method: 'get', path: '/admin/platform-rbac/roles', tag: 'Ops admin', summary: 'Catalogue rôles d’administration plateforme CaddyNote', auth: 'bearer', roles: ['admin'] },
  { method: 'get', path: '/admin/platform-rbac/permissions', tag: 'Ops admin', summary: 'Catalogue permissions plateforme', auth: 'bearer', roles: ['admin'] },
  { method: 'get', path: '/admin/platform-rbac/users/:id/roles', tag: 'Ops admin', summary: 'Attributions rôles d’un admin', auth: 'bearer', roles: ['admin'] },
  { method: 'put', path: '/admin/platform-rbac/users/:id/roles', tag: 'Ops admin', summary: 'Remplacer les rôles plateforme', auth: 'bearer', roles: ['admin'] },
  { method: 'post', path: '/admin/platform-rbac/users/:id/roles', tag: 'Ops admin', summary: 'Attribuer un rôle plateforme', auth: 'bearer', roles: ['admin'] },
  { method: 'delete', path: '/admin/platform-rbac/users/:id/roles/:roleCode', tag: 'Ops admin', summary: 'Révoquer un rôle plateforme', auth: 'bearer', roles: ['admin'] },
  ...
  { method: 'post', path: '/services/transport/routes/:id/stops', tag: 'Services (Lot 9)', summary: 'Ajouter un arrêt', auth: 'bearer', roles: [...direction], statuses: [201] },
  { method: 'patch', path: '/services/transport/stops/:id', tag: 'Services (Lot 9)', summary: 'Modifier un arrêt', auth: 'bearer', roles: [...direction] },
  { method: 'delete', path: '/services/transport/stops/:id', tag: 'Services (Lot 9)', summary: 'Supprimer un arrêt', auth: 'bearer', roles: [...direction], statuses: [204] },
  { method: 'post', path: '/services/transport/routes/:id/schedule', tag: 'Services (Lot 9)', summary: 'Ajouter un créneau hebdomadaire', auth: 'bearer', roles: [...direction], statuses: [201] },
  { method: 'patch', path: '/services/transport/schedule/:id', tag: 'Services (Lot 9)', summary: 'Modifier un créneau', auth: 'bearer', roles: [...direction] },
  { method: 'delete', path: '/services/transport/schedule/:id', tag: 'Services (Lot 9)', summary: 'Supprimer un créneau', auth: 'bearer', roles: [...direction], statuses: [204] },
  { method: 'get', path: '/push/vapid-public-key', tag: 'Web Push', summary: 'Clé VAPID publique', auth: 'public' },
  { method: 'post', path: '/push/subscribe', tag: 'Web Push', summary: 'Enregistrer un abonnement', auth: 'bearer', statuses: [201, 501] },
  { method: 'delete', path: '/push/subscribe', tag: 'Web Push', summary: 'Retirer un abonnement', auth: 'bearer', statuses: [204] },
  { method: 'get', path: '/admin/integrations/desps/status', tag: 'DESPS', summary: 'Statut connecteur DESPS', auth: 'bearer', roles: ['admin'] },
  { method: 'post', path: '/admin/integrations/desps/ping', tag: 'DESPS', summary: 'Ping DESPS', auth: 'bearer', roles: ['admin'], statuses: [200, 501] },
  { method: 'post', path: '/admin/integrations/desps/sync/students', tag: 'DESPS', summary: 'Dry-run export élèves', auth: 'bearer', roles: ['admin'] },
  { method: 'post', path: '/communications/ai/draft', tag: 'Communications', summary: 'Brouillon IA hors exercices', auth: 'bearer', statuses: [200, 403, 501] },
  ...
  { method: 'get', path: '/services/mine', tag: 'Services (Lot 9)', summary: 'Parent — cantine/transport des enfants liés + catalogue', auth: 'bearer', roles: ['parent'] },
  { method: 'post', path: '/services/mine/transport/enroll', tag: 'Services (Lot 9)', summary: 'Parent — inscrire un enfant à un circuit', auth: 'bearer', roles: ['parent'], statuses: [201] },
  { method: 'post', path: '/services/mine/canteen/subscribe', tag: 'Services (Lot 9)', summary: 'Parent — souscrire un enfant à la cantine', auth: 'bearer', roles: ['parent'], statuses: [201] },
  { method: 'post', path: '/students', tag: 'Élèves', summary: 'Créer une fiche élève sans login', auth: 'bearer', roles: [...direction], statuses: [201] },
  { method: 'post', path: '/students/:id/activate-login', tag: 'Élèves', summary: 'Activer l’espace élève (e-mail ou alias opaque + MDP provisoire)', auth: 'bearer', roles: [...direction], statuses: [201, 409] },
  { method: 'post', path: '/users/:id/admin-reset-password', tag: 'Utilisateurs', summary: 'Mot de passe provisoire (admin ou secrétariat du tenant)', auth: 'bearer', roles: [...direction] },
