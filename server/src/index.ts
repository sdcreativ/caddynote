...
import { partnersPublicRouter, partnersAdminRouter } from './routes/partners.routes.js';
import { vitrinePublicRouter, vitrineAdminRouter } from './routes/vitrine.routes.js';
...
app.use('/public', partnersPublicRouter);
app.use('/public', vitrinePublicRouter);
app.use('/admin', announcementAdminRouter);
app.use('/admin', partnersAdminRouter);
app.use('/admin', vitrineAdminRouter);
