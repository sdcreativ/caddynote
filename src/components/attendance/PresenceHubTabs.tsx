...
/** Onglets Appel | Justificatifs pour le hub Présences (Direction / secrétariat / enseignant). */
    ...
    <div className="mb-6 flex flex-wrap items-center gap-2 border-b border-slate-200 pb-3">
      ...
      <Link
        ...
        className={cn(
          ...
          onCall ? 'bg-blue-50 text-blue-700' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-800'
        )}
        aria-current={onCall ? 'page' : undefined}
      >
        {t('items.call')}
      </Link>
      <Link
