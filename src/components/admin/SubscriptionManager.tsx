...
const SubscriptionManager = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{trialSubscriptions} en essai · {cancelledSubscriptions} annulés</p>
          </CardContent>
        </Card>
      ...
      {/* Graphiques */}
      <div id="financial-analytics" className="grid grid-cols-1 lg:grid-cols-2 gap-6 scroll-mt-6">
        <Card>
          <CardHeader>
